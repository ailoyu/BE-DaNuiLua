...
//			msg.setReplyTo(InternetAddress.parse(from, false));
    ...
    public static String getEmailContentAdmin(Order order, List<OrderDetail> orderDetails) {
        ...
        String noiDung = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "        \n" +
                "  <div style=\"font-size: 42px; line-height: 140%; text-align: center; word-wrap: break-word;\">\n" +
                "    <p style=\"line-height: 140%;\"><strong><span style=\"color: #ecf0f1; line-height: 35px;\">Hồng Quang</span></strong></p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "        \n" +
                "  <div style=\"font-size: 14px; line-height: 130%; text-align: left; word-wrap: break-word;\">\n" +
                "    <p style=\"font-size: 14px; line-height: 130%; text-align: center;\"><span style=\"font-size: 30px; line-height: 39px; color: #3598db;\"><strong><span style=\"line-height: 39px; font-family: Poppins, sans-serif; font-size: 30px;\">Bạn vừa có thêm 1 đơn hàng</span></strong></span></p>\n" +
                "<p style=\"font-size: 14px; line-height: 130%; text-align: center;\"><span style=\"font-size: 30px; line-height: 39px; color: #3598db;\"><strong><span style=\"line-height: 39px; font-family: Poppins, sans-serif; font-size: 30px;\">Dưới đây là thông tin chi tiết của đơn hàng</span></strong></span></p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "        \n" +
                "  <div style=\"font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;\">\n" +
                "    <p style=\"font-size: 14px; line-height: 140%; text-align: center;\"><span style=\"color: #ecf0f1; font-size: 14px; line-height: 19.6px;\"><span style=\"font-size: 16px; line-height: 22.4px; font-family: arial, helvetica, sans-serif;\">Đơn hàng này có </span><span style=\"font-size: 16px; line-height: 22.4px; font-family: arial, helvetica, sans-serif;\"><strong>Mã đơn hàng: "+order.getId()+"</strong></span></span></p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
        ...
        noiDung += "  <!--[if (!mso)&(!IE)]><!--></div><!--<![endif]-->\n" +
                ...
                "        \n" +
                "  <div style=\"font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;\">\n" +
                "    <p style=\"line-height: 140%;\"><strong>Ghi chú của khách hàng: </strong> "+order.getNote()+"</p>\n" +
                "<p style=\"line-height: 140%;\">Chân thành cảm ơn bạn,</p>\n" +
                "<p style=\"line-height: 140%;\"><a href=\"https://hongquang.netlify.app/admin/order-confirm/pending\">Nhấn vào đây để xác nhận đơn hàng</a></p>\n" +
                "<p style=\"line-height: 140%;\">Nếu bạn chưa thực hiện thanh toán, bạn có thể chuyển khoản qua: </p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
